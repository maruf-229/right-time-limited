...
use App\Http\Controllers\Frontend\AUS\IndexController;
use App\Http\Controllers\Frontend\AUS\IndustriesController;
use App\Http\Controllers\Frontend\AUS\ServicesController;
use Illuminate\Support\Facades\Route;

Route::prefix('aus')->group(function (){
