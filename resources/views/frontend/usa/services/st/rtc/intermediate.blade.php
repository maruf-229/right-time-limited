...
<div class="page-header">
    ...
    <div class="container">
        <ul class="thm-breadcrumb list-unstyled">
            ...
            <li><a href="{{ url('usa/services/security-training/right-time-customized') }}">Right Time Customized</a></li>
            <li>Intermediate (Corporate)</li>
        </ul>
        <h2 class="page-header__title">Intermediate (Corporate)</h2><!-- /.page-header__title -->
    </div><!-- /.container -->
</div><!-- /.page-header -->
            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    <div class="sidebar__item sidebar__item--category">
                        @include('frontend.usa.services.st.rtc.cmn')
                    </div><!-- /.sidebar__item -->
                </div><!-- /.sidebar -->
            </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
