...
@section('content')
    ...
    <div class="page-header">
        <div class="page-header__bg"
             style="background-image: url({{ asset('https://www.chfi.tn/file/sites/8/2021/04/Wallpaper-Anarchy-Computer-Hack-Hacker-Hacking-Intern35-scaled-1-1024x640.jpg') }});"></div>
        <!-- /.page-header__bg -->
        <div class="container">
