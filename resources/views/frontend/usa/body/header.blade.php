...
<nav class="main-menu sticky-header">
    <div class="container-fluid">
        ...
        <ul class="main-menu__list">
            <li>
                <a href="{{ url('/usa') }}">Home</a>
            </li>
            <li >
                <a href="{{ url('usa/about-us') }}">About Us</a>
                {{--                <ul>--}}
            ...
            <li class="menu-item-has-children">
                <a href="{{ url('usa/industries') }}">Industries</a>
                <ul>
                    <li><a href="{{ url('usa/industries/bank-nbfi') }}">Bank & NBFI</a></li>
                    <li><a href="{{ url('usa/industries/telecommunications') }}">Telecommunications</a></li>
                    <li><a href="{{ url('usa/industries/pci') }}">Payment Card Industry</a></li>
                    <li><a href="{{ url('usa/industries/educational-institutions') }}">Educational Institutions</a></li>
                    <li><a href="{{ url('usa/industries/erm') }}">eCommerce & Retail Merchants</a></li>
                    <li><a href="{{ url('usa/industries/health-care') }}">Health Care</a></li>
                </ul>
            </li>

            <li>
                <a href="{{ url('usa/partners') }}">Partners</a>
                <ul>
            ...
            <li class="menu-item-has-children">
                <a href="{{ url('usa/services') }}">Services</a>
                <ul>
                    <li class="menu-item-has-children"><a href="{{ url('usa/services/consultation') }}">Consultation</a>

                        <ul>
                            <li><a href="{{ url('usa/services/consultation/information-security') }}">Information Security-Specially Cyber Security Consulting</a></li>
                            <li><a href="{{ url('usa/services/consultation/partners-management') }}" >Project Management</a></li>
                            <li><a href="{{ url('usa/services/consultation/providing-security') }}">Providing Security</a></li>
                            <li><a href="{{ url('usa/services/consultation/DC-DRS') }}">Consultation on Shaping the DC & DRS</a></li>
                            <li><a href="{{ url('usa/services/consultation/swift-cyber-security-consulting') }} ">Swift Cyber Security Consulting</a></li>
                            <li><a href="{{ url('usa/services/consultation/technical-documentation-on-ICT') }} ">Technical Documentation on ICT</a></li>
                        </ul>
                    </li>

                    <li class="menu-item-has-children"><a href="{{ url('usa/services/auditing') }}">Auditing</a>
                        <ul>
                            <li><a href="{{ url('usa/services/auditing/information-system-audit') }}">Information System Audit</a></li>
                            <li><a href="{{ url('usa/services/auditing/information-technology-audit') }}">Information Technology Audit</a></li>
                            <li><a href="{{ url('usa/services/auditing/information-security-graded-audit') }}">Information Security Graded Audit</a></li>
                            <li><a href="{{ url('usa/services/auditing/DC-DRS-audit') }}">DC & DRS Auditing</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children"><a href="{{ url('usa/services/security-assessment-testing') }}" >Security Testing</a>
                        <ul>
                            <li><a href="{{ url('usa/services/security-assessment-testing/VAPT') }}">Vulnerability Assessment & Presentation Testing Services</a></li>
                            <li><a href="{{ url('usa/services/security-assessment-testing/digital-forensics') }}">Digital Forensics</a></li>
                            <li><a href="{{ url('usa/services/security-assessment-testing/code-review') }}">Code Review</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children"><a href="{{ url('usa/services/standard-implementation-certification') }}">Certification</a>
                        <ul>
                            <li> <a href="{{ url('usa/services/standard-implementation-certification/pci-dss') }}" >Payment Card Industry Data Security Standards</a></li>
                            <li><a href="{{ url('usa/services/standard-implementation-certification/iso') }}" >International Organization for Standardization-ISO</a></li>
                            <li><a href="{{ url('usa/services/standard-implementation-certification/CMMI') }}">CMMI</a></li>
                            <li><a href="{{ url('usa/services/standard-implementation-certification/SCIA') }}" >SWIFT CSP Independent Assesment</a></li>
                            <li><a href="{{ url('usa/services/standard-implementation-certification/') }}" >TIA 942 for Data Center</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children"><a href="{{ url('usa/services/solutions') }}">Solutions</a>
                        <ul>
                            ...
                            <li><a href="{{ url('usa/services/solutions/SIEM-solutions') }}" >Core Impact</a></li>
            ...
            <li class="menu-item-has-children">
                <a href="{{ url('usa/services/security-training') }}">Training</a>
                <ul>
                    <li class="menu-item-has-children"><a href="{{ url('usa/services/security-training/assessment') }}">Assessment</a>
                        <ul>
                            <li><a href="{{ url('usa/services/security-training/assessment/ethical-hacker') }}">Certified Ethical Hacker (CEH)</a></li>
                            <li><a href="{{ url('usa/services/security-training/assessment/CPENT') }}">Certified Penetration Testing Professional(CPENT)</a></li>
                            <li><a href="{{ url('usa/services/security-training/assessment/CHFI') }}">Computer Hacking Forensic Investigator(CHFI)</a></li>
                            <li><a href="{{ url('usa/services/security-training/assessment/OSINT') }}">Open Source Intelligence(OSINT)</a></li>
                            <li><a href="{{ url('usa/services/security-training/assessment/GPEN') }}">GIAC Penetration Tester(GPEN)</a></li>
                            <li><a href="{{ url('usa/services/security-training/assessment/GWAPT') }}">GIAC Web Application Penetration Tester(GWAPT)</a></li>

                        </ul>
                    </li>

                    <li class="menu-item-has-children"><a href="{{ url('usa/services/security-training/management') }}">Management</a>
                        <ul>
                            <li><a href="{{ url('usa/services/security-training/management/CDRP') }}">Certified Disaster Recovery Professional</a></li>
                            <li><a href="{{ url('usa/services/security-training/management/CIH') }}">Certified Incident Handler</a></li>
                            <li><a href="{{ url('usa/services/security-training/management/CSA') }}">Certified SOC Analyst(CSA)</a></li>
                            <li><a href="{{ url('usa/services/security-training/management/CTIA') }}">Certified Threat Intelligence Analyst(CTIA)</a></li>
                            <li><a href="{{ url('usa/services/security-training/management/CISA') }}">Certified Information Systems Auditor(CISA)</a></li>
                            <li><a href="{{ url('usa/services/security-training/management/CISM') }}">Certified Information Security Manager(CISM)</a></li>
                            <li><a href="{{ url('usa/services/security-training/management/CISSP') }}">Certified Information Systems Security Professional(CISSP)</a></li>
                            <li><a href="{{ url('usa/services/security-training/management/GCPM') }}">GIAC Certified Project Manager (GCPM)</a></li>
                        </ul>
                    </li>

                    <li class="menu-item-has-children"><a href="{{ url('usa/services/security-training/right-time-customized') }}">Customized</a>
                        <ul>
                            <li><a href="{{ url('usa/services/security-training/right-time-customized/basic') }}">Basic (Corporate)</a></li>
                            <li><a href="{{ url('usa/services/security-training/right-time-customized/advanced') }}">Advance (Corporate)</a></li>
                            <li><a href="{{ url('usa/services/security-training/right-time-customized/intermediate') }}">Intermediate (Corporate)</a></li>
                            <li><a href="{{ url('usa/services/security-training/right-time-customized/one-to-one-training') }}">One to One Training</a></li>
            ...
            <li><a href="{{ url('usa/contact') }}">Contact Us</a></li>
        </ul><!-- /.main-menu__list -->
