...
<div class="page-wrapper">
    ...
    {{--header content--}}
    @include('frontend.usa.body.header')
            ...
            <div class="owl-carousel thm-owl__carousel thm-owl__carousel--with-shadow service-four__carousel"
                ...
                <div class="item">
                    <div class="service-card-three">
                        ...
                        <div class="service-card-three__content">
                            <h3 class="service-card-three__title"><a href="{{ url('usa/services/consultation') }}">Consultation
                ...
                <div class="item">
                    <div class="service-card-three">
                        ...
                        <div class="service-card-three__content">
                            <h3 class="service-card-three__title"><a href="{{ url('usa/services/auditing') }}">Auditing</a></h3><!-- /.service-card-three__title -->
                            <div class="service-card-three__text">Providing the solutions for non-IT businesses.
                            </div><!-- /.service-card-three__text -->
                        </div><!-- /.service-card-three__content -->
                    </div><!-- /.service-card-three -->
                    ...
                    <div class="service-card-three">
                        ...
                        <div class="service-card-three__content">
                            <h3 class="service-card-three__title"><a
                                    href="{{ url('usa/services/security-assessment-testing') }}">Security <br>
                ...
                <div class="item">
                    <div class="service-card-three">
                        ...
                        <div class="service-card-three__content">
                            <h3 class="service-card-three__title"><a href="{{ url('usa/services/standard-implementation-certification') }}">Standard
                                    <br>
                ...
                <div class="item">
                    <div class="service-card-three">
                        ...
                        <div class="service-card-three__content">
                            <h3 class="service-card-three__title"><a href="{{ url('usa/services/solutions') }}">Solutions</a></h3><!-- /.service-card-three__title -->
                            <div class="service-card-three__text">Providing the solutions for non-IT businesses.
                            </div><!-- /.service-card-three__text -->
                        </div><!-- /.service-card-three__content -->
                    </div><!-- /.service-card-three -->
        ...
        <div class="row gutter-y-30">
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="footer-widget footer-widget--about">
                    <a href="{{ url('/usa') }}" class="footer-widget__logo">
...
<div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
        ...
        <ul class="mobile-nav__contact list-unstyled">
            <li>
                <i class="fa fa-phone"></i>
                <a href="tel:+8898006802">(+1) 818 779 0442</a>
            </li>

            <li>
                <i class="fa fa-phone"></i>
                <a href="tel:+8898006802">(+1) 818 862 5708</a>
            </li>

            <li>
                <i class="fa fa-envelope"></i>
                <a href="mailto:needhelp@company.com">coo.usa@righttime.biz</a>
            </li>
            <li>
                <i class="fa fa-map-marker-alt"></i>
                14108 Hamlin Street, Unit # 7, Van Nuys, CA-91401
