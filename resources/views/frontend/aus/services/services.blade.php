        ...
        <div class="owl-carousel thm-owl__carousel thm-owl__carousel--with-shadow service-four__carousel"
            ...
            <div class="item">
                <div class="service-card-three">
                    ...
                    <div class="service-card-three__content">
                        <h3 class="service-card-three__title"><a href="{{ url('aus/services/consultation') }}">Consultation
            ...
            <div class="item">
                <div class="service-card-three">
                    ...
                    <div class="service-card-three__content">
                        <h3 class="service-card-three__title"><a href="{{ url('aus/services/auditing') }}">Auditing</a></h3><!-- /.service-card-three__title -->
                        <div class="service-card-three__text">Providing the solutions for non-IT businesses.
                        </div><!-- /.service-card-three__text -->
                    </div><!-- /.service-card-three__content -->
                </div><!-- /.service-card-three -->
                ...
                <div class="service-card-three">
                    ...
                    <div class="service-card-three__content">
                        <h3 class="service-card-three__title"><a
                                href="{{ url('aus/services/security-assessment-testing') }}">Security <br>
            ...
            <div class="item">
                <div class="service-card-three">
                    ...
                    <div class="service-card-three__content">
                        <h3 class="service-card-three__title"><a href="{{ url('aus/services/standard-implementation-certification') }}">Standard
                                <br>
            ...
            <div class="item">
                <div class="service-card-three">
                    ...
                    <div class="service-card-three__content">
                        <h3 class="service-card-three__title"><a href="{{ url('aus/services/security-training') }}">Security
                                <br>
            ...
            <div class="item">
                <div class="service-card-three">
                    ...
                    <div class="service-card-three__content">
                        <h3 class="service-card-three__title"><a href="{{ url('aus/services/solutions') }}">Solutions</a></h3><!-- /.service-card-three__title -->
                        <div class="service-card-three__text">Providing the solutions for non-IT businesses.
                        </div><!-- /.service-card-three__text -->
                    </div><!-- /.service-card-three__content -->
                </div><!-- /.service-card-three -->
